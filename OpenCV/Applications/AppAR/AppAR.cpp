...
#define APP_AR_USE_SIFT_SURF 1

#if APP_AR_USE_SIFT_SURF
...
void AppAR::process(const Mat& objectImage, const Mat& sceneImage)
{
    ...
    Mat resultImage;
    cvtColor(sceneImage, resultImage, CV_GRAY2RGB);
